...
const login = () => {
    ...
    return (
        <>
            <svg width="55px" height="55px" viewBox="0 0 47 54" className='login__logo'>
            ...
            <div className='login__card'>
                <div className='login__card-body'>
                    <h2 className='login__card-title'>{translation[lang]["Accéder à tout Forinov"]}</h2>
                    <span class="login__redirect">{translation[lang]["Pas encore membre Forinov ?"]}
                        &nbsp;<a class="text-primary" href="/register">{translation[lang]["Inscrivez-vous"]}</a></span>

                    <form className="login__form">
                        <a className="login__google-provider">
                            <i className="fa-brands fa-google"></i>
                            {translation[lang]["Connexion avec Google"]}
                        </a>

                        <div className='login__inputs'>
                            <input type="text" class="login__input" id="Email" name="Email" placeholder={translation[lang]["Adresse mail *"]} required />
                            <input type="password" class="login__input" id="Password" name="Password" placeholder={translation[lang]["Mot de passe *"]} required />
                        </div>
                        <input type="submit" className='callToAction login__submit  login__signin' value={translation[lang]["Se connecter"]} />
                        <input type="submit" className='callToActionAlternative login__submit login__signup' value={translation[lang]["Créer son compte"]} />

                        <a href="" style={{ marginTop: '2em', marginBottom: '4em' }}>{translation[lang]["Mot de passe oublié ?"]}</a>

                        <div className="login__details">
                            <p>{translation[lang]["Une question, un problème ? "]}<a href="">{translation[lang]["Nous contacter"]}</a></p>
                            <p>{translation[lang]["FORINOV s'engage à respecter vos données."]}</p>
                            <p>{translation[lang]["En continuant votre inscription, vous acceptez nos "]}<a href="">{translation[lang]["Conditions Générales"]}</a>..</p>
                        </div>
                    </form>
                </div>
            </div>
