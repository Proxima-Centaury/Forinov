        ...
        <>
            ...
            <div className='login__card'>
                <div className='login__card-body'>
                    <h2>
                        <b className='login__card-title'>Accéder à tout Forinov</b>
                        <br />
                        <span class="login__redirect">Pas encore membre Forinov ?
                            &nbsp;<a class="text-primary" href="/v5_form4pchoice.php?">Inscrivez-vous</a></span>
                    </h2>
                    ...
                    <form className="login__form">
                        ...
                        <div className='login__inputs'>
                            <input type="text" class="login__input" id="Email" name="Email" placeholder="Adresse mail *" required/>
                            <input type="password" class="login__input" id="Password" name="Password" placeholder="Mot de passe *"  required/>
                        </div>
                        <input type="submit" className='callToAction login__submit  login__signin' value={'Se connecter'} />
                        <input type="submit" className='callToActionAlternative login__submit login__signup' value={'Créer son compte'}  />

                        <a href="" style={{marginTop: '2em', marginBottom: '4em'}}>Mot de passe oublié ?</a>

                        <div className="login__details">
                            <p>Une question, un problème ? <a href=""> Nous contacter</a></p>
                            <p>FORINOV s'engage à respecter vos données.</p>
                            <p>En continuant votre inscription, vous acceptez nos <a href=""> Conditions Générales</a>..</p>
                        </div>
                    </form>
                </div>
            </div>
