        ...
        `}
				...
				<div className={styles.hero}>
					<div className={styles.text}>
						<h1 className={styles.title}>
							{translations[lang]["index_partners_hero"]}
						</h1>
						<p className={styles.paragraph}>
							{translations[lang]["index_partners_hero_text"]}
						</p>
						<button className={styles.toVideo}>
							{translations[lang]["index_partners_hero_cta"]}
						</button>
					</div>
					<img
			...
			<div className={styles.container2}>
				<section className={styles.section2}>
					...
					<h1 className={styles.companiesTitle}>
						{translations[lang]["index_partners_cta_title"]}
					</h1>
			...
			<div className={styles.container3}>
				<section className={styles.section3}>
					<h1 className={styles.timelineTitle}>
						{translations[lang]["index_partners_timeline_title"]}
					</h1>
					<p className={styles.timelineText}>
						{translations[lang]["index_partners_timeline_text"]}
					</p>
				...
				<div className={styles.lastOps}>
					<div className={styles.innerSlider}>
						...
						<div className={styles.joinCard}>
							<h1>{translations[lang]["index_partners_lastops_card_title"]}</h1>
							<Link
								href="/"
								className="callToAction"
							>
								<span>
									{translations[lang]["index_partners_lastops_card_cta"]}
								</span>
							</Link>
						</div>
					</div>
					...
					<div className={styles.carousel_wrapper}>
						...
						>
							<div className={styles.collapseWrapper}>
								{translations[lang]["partners_accordion1"].map((item, index) => {
									return (
										<AccordionItem
											title={item.title}
							...
							{/* 2nd accordion */}
							<div className={styles.collapseWrapper}>
							{translations[lang]["partners_accordion2"].map((item, index) => {
									return (
										<AccordionItem
											title={item.title}
											content={item.content}
											identifier={index + translations[lang]["partners_accordion1"].length}
											color="#D1F2E4"
											textColor="#38BF84"
											key={index + translations[lang]["partners_accordion1"].length + "-accordion2"}
										></AccordionItem>
									);
								})}
							</div>
