...
const PartnerSolutions = (pageProps: HomeInterface) => {
    ...
    return <Fragment>
            ...
            <section className="containerFull" data-type="partner">
                ...
                <div className={SolutionsStyles.banner + ' ' + SolutionsStyles.bannerWithImg} style={{ position: 'relative', marginBottom: "10rem" }}>
                    <div className="container">
                        ...
                        <Image
                            ...
                            width="500"
                            height="500"
                            className={SolutionsStyles.bannerImgSeating}
                        >
                        </Image>
                    </div>
                </div>
