...
import { formatNameForUrl } from "../utilities/classes/utilities";
...
const Home = (pageProps: TPage): JSX.Element => {
	...
	return <div className={ HomeStyles.page } data-page="home">
			...
			<div className="boxedContent">
				...
				<div className={ HomeStyles.startupsCategoriesSection }>
					{ categories.startups.map((category: any, key: number) => {
						const formatCategoryName = category.name.toLowerCase().replaceAll(" ", "-").replaceAll("---", "-");
						const url = `/${ language }/directories/startups/${ formatCategoryName }_${ category.id }`;
