                        ...
                        <ul>
                            { step.list.map((item: String, key: Key) => <li key={ key }>
                                <div>
                                    ...
                                    <Format { ...carouselProps } content={ translations[item as keyof Object] + "." }/>
                                </div>
                            </li>) }
                        </ul>
                    </div>
        ...
        <div className={ CarouselStyles.container } data-carousel={ component }>
            { steps.map((step, key) => <div key={ key } className={ CarouselStyles.itemFullWidth }>
                ...
                <div className={ CarouselStyles.steps }>
                    <Separator { ...carouselProps } type="vertical"/>
...
const InfiniteScrollHorizontal = (carouselProps: any) => {
    return <div className={ CarouselStyles.infinite } data-size={ (carouselProps.component !== "CompaniesLogos") ? "classic" : "small" }>
        <div className={ CarouselStyles.firstCopy } data-count={ carouselProps.data.length }>
            <Items { ...carouselProps }/>
        </div>
        <div className={ CarouselStyles.secondCopy } data-count={ carouselProps.data.length }>
            <Items { ...carouselProps }/>
        </div>
    </div>;
};
