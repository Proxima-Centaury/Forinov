...
/* ------------------------------------------------------------------------------------------------------------------------------------------------ */
const formatGetLandingOpportunities = (response: UnknownResponseType): OpportunityType[] => {
    const opportunities: UnknownOpportunityType[] = Object.values(response?.PROJECT) || [];
    return opportunities.map((opportunity: UnknownOpportunityType): OpportunityType => ({
