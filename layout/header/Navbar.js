...
const Navbar = () => {
    ...
    let tooltipToggler = useRef(null);
    ...
    return (
        <nav className="layout__navbar">
            ...
            <div className='navbar-cta'>
                ...
                <Link href="/login">
                    <div>
                        <i className="fa-solid fa-user navbar-login" ref={tooltipToggler}></i>
                        {isOpen ? <div className='navbar-tooltip'>Se connecter</div> : null}
                    </div>
                </Link>

                <Link href="/login">
                    <button className='cta-blue'>M'inscire</button>
                </Link>
            </div>
        </nav>
    )
