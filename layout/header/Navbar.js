    ...
    return <>
        <nav className="layout__navbar">
            ...
            <ul className='navbar-links'>
                <li className='navbar-link'>{translation[lang]["Startups"]}</li>
                <li className='navbar-link'>{translation[lang]["Entreprises"]}</li>
                <li className='navbar-link'>{translation[lang]["Partenaires"]}</li>
                <li className='navbar-link'>{translation[lang]["À propos"]}</li>
                <li className='navbar-link'>{translation[lang]["Nos membres"]}</li>
            </ul>
            ...
            <div className='navbar-hamburger'>
                ...
                {isOpen ? (
                    <ul className='navbar-hamburger-links'>
                        <li className='navbar-hamburger-link'>{translation[lang]["Startups"]}</li>
                        <li className='navbar-hamburger-link'>{translation[lang]["Entreprises"]}</li>
                        <li className='navbar-hamburger-link'>{translation[lang]["Partenaires"]}</li>
                        <li className='navbar-hamburger-link'>{translation[lang]["À propos"]}</li>
                        <li className='navbar-hamburger-link'>{translation[lang]["Nos membres"]}</li>
                        <div className='navbar-hamburger-link-cta'>
                            <Link href={"/login"}>
                                <a>
                                    ...
                                    ></i>
                                    <div className='navbar-tooltip'>{translation[lang]["Me connecter"]}</div>
                                </a>
                            </Link>

                            <Link href={"/register"}>
                                <a className='callToAction'>{translation[lang]["M'inscrire"]}</a>
                            </Link>
                        </div>
