...
const Footer = ({ states, config }: FooterInterface) => {
    ...
    const { footer }: any = config;
    return <footer className={ FooterStyles.footer }>
        { footer.map((section: String, key: KeyType) => {
            return <div className={ FooterStyles.section }>
                { (section.length > 0) ? <h6>{ section }</h6> : null }
            </div>;
        }) }
        {/* <div className={ FooterStyles.section }>
            ...
            {translations["Forinov connecte startups, entreprises et partenaires pour matcher l’offre et le besoin d’innovation."]}
            </p>
            ...
            {translations["Aide et support"]}
            </a>
        </div>
        <div className={ FooterStyles.section }>
            <h2 className="footer__link-list-title">
            {translations["Nos offres"]}
            </h2>

            <ul className="footer__link-list-items">
                <li className="footer__link-list-item">
                    <a href="https://www.forinov.fr/">
                    {translations["Solutions entreprises"]}
                    </a>
                </li>

                <li className="footer__link-list-item">
                    <a href="https://www.forinov.fr/">
                    {translations["Solutions startups"]}
                    </a>
                </li>

                <li className="footer__link-list-item">
                    <a href="https://www.forinov.fr/">
                    {translations["Solutions partenaires"]}
                    </a>
                </li>
            </ul>
        </div>
        <div className={ FooterStyles.section }>
            ...
            <ul className="footer__link-list-items">
                <li className="footer__link-list-item">
                    <a href="https://www.forinov.fr/">
                    {translations["Qui sommes-nous ?"]}
                    </a>
                </li>

                <li className="footer__link-list-item">
                    <a href="https://www.forinov.fr/">
                    {translations["Contacts et recrutement"]}
                    </a>
                </li>
                ...
                <li className="footer__link-list-item">
                    <a href="https://www.forinov.fr/">
                    {translations["Mentions légales"]}
                    </a>
                </li>

                <li className="footer__link-list-item">
                    <a href="https://www.forinov.fr/">
                    {translations["Protection des données"]}
                    </a>
                </li>
        ...
        <div className={ FooterStyles.section }>
            <h2 className="footer__link-list-title">
            {translations["Communauté"]}
            </h2>

            <ul className="footer__link-list-items">
                <li className="footer__link-list-item">
                    <a href="https://www.forinov.fr/">
                    {translations["Annuaire Startups"]} 
                    </a>
                </li>

                <li className="footer__link-list-item">
                    <a href="https://www.forinov.fr/">
                    {translations["Annuaire Entreprises"]} 
                    </a>
                </li>

                <li className="footer__link-list-item">
                    <a href="https://www.forinov.fr/">
                    {translations["Annuaire Partenaires"]} 
                    </a>
                </li>

                <li className="footer__link-list-item">
                    <a href="https://www.forinov.fr/">
                    {translations["Annuaire d'appels à projet"]}
                    </a>
                </li>

                <li className="footer__link-list-item">
                    <a href="https://www.forinov.fr/">
                    {translations["Concours et challenges startups"]}
                    </a>
                </li>
            </ul>
        </div>
