        ...
        <footer className="layout__footer">
            <div className="footer__about-forinov">
                ...
                <p className="footer__about-text">
                    Forinov connecte startups, entreprises et partenaires pour matcher l’offre et le besoin d’innovation.
                </p>
            ...
            <div className="footer__link-list">
                ...
                <ul className="footer__link-list-items">
                    ...
                    <li className="footer__link-list-item">
                        <a href="https://www.forinov.fr/">
                            Annuaire d'appels à projet
                        </a>
                    </li>

                    <li className="footer__link-list-item">
                        <a href="https://www.forinov.fr/">
                            Concours et challenges startups
                        </a>
                    </li>
                </ul>
            </div>
